...
int preprocess_main() {
  ...
  while(true) {
    ...
    for (size_t i = 0; i < frag->num_hits(); ++i) {
      ...
      if (read_r) {
        if (i==0) { ref_left_first = !read_r->first; }
